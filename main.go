...
func main() {
    ...
    // Added declaration for err to ensure it is defined before any usage later in the file.
    var err error

    // The rest of the original main function implementation follows unchanged.
